...
export declare class ExpressionDescriptor {
    ...
    options: Options;
    i18n: Locale;
    static toString(expression: string, { throwExceptionOnParseError, verbose, dayOfWeekStartIndexZero, monthStartIndexZero, use24HourTimeFormat, locale, logicalAndDayFields, }?: Options): string;
