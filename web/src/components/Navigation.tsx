...
const Navigation = () => {
  ...
  return (
    <nav className="flex items-center space-x-1 md:space-x-2 bg-slate-800/30 p-1.5 rounded-full">
      <Link
        to="/"
        className={`flex items-center space-x-1.5 px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-200 hover:bg-blue-500/20 ${
          isActive('/') ? 'bg-blue-500/30 text-blue-400' : 'text-slate-300 hover:text-blue-400'
        }`}
      >
      ...
      <Link
        to="/cloud-accounts"
        className={`flex items-center space-x-1.5 px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-200 hover:bg-purple-500/20 ${
          isActive('/cloud-accounts') ? 'bg-purple-500/30 text-purple-400' : 'text-slate-300 hover:text-purple-400'
        }`}
      >
      ...
      <Link
        to="/instances"
        className={`flex items-center space-x-1.5 px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-200 hover:bg-blue-500/20 ${
          isActive('/instances') ? 'bg-blue-500/30 text-blue-400' : 'text-slate-300 hover:text-blue-400'
        }`}
      >
      ...
      <Link
        to="/schedules"
        className={`flex items-center space-x-1.5 px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-200 hover:bg-blue-500/20 ${
          isActive('/schedules') ? 'bg-blue-500/30 text-blue-400' : 'text-slate-300 hover:text-blue-400'
        }`}
      >
      ...
      <Link
        to="/recommendations"
        className={`flex items-center space-x-1.5 px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-200 hover:bg-blue-500/20 ${
          isActive('/recommendations') ? 'bg-blue-500/30 text-blue-400' : 'text-slate-300 hover:text-blue-400'
        }`}
      >
      ...
      <Link
        to="/audit-log"
        className={`flex items-center space-x-1.5 px-3 py-1.5 text-sm font-medium rounded-full transition-all duration-200 hover:bg-blue-500/20 ${
          isActive('/audit-log') ? 'bg-blue-500/30 text-blue-400' : 'text-slate-300 hover:text-blue-400'
        }`}
      >
