...
must_haves:
  truths:
    ...
    - "Savings calculations use integer cents (no floating point)"
    - "Stopped duration is capped at 7 days maximum (AWS auto-restart)"
...
- SavingsCalculator with duration × hourly_cost_cents logic, 7-day cap, and ongoing savings calculation
</objective>
